...
integer division of _rs1_ by _rs2_, rounding towards zero.# [#manual:insts:rem-remu:operation]#REM and REMU
...
respectively.# [#manual:insts:remw-remuw:result_sign]#Both REMW and REMUW always sign-extend the 32-bit result
