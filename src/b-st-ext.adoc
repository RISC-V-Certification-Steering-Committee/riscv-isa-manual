...
[#norm:rv32_shamt_resvd]#For RV32, the encodings corresponding to shamt[5]=1 are reserved.#
...
Description::
[#norm:orc-b_behav]#Combines the bits within each byte using bitwise logical OR.
...
Description::
[#norm:ror_op]#This instruction performs a rotate right of _rs1_ by the amount in least-significant log2(XLEN) bits of _rs2_.#
...
Description::
[#norm:xnor_op]#This instruction performs the bit-wise exclusive-NOR operation on _rs1_ and _rs2_.#
