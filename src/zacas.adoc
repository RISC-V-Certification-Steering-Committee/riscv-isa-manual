...
[#norm:Zacas_amocasw_pma_instr]#`AMOCASW` indicates that in addition to instructions indicated by `AMOArithmetic`
level support, the `AMOCAS.W` instruction is supported.# [#norm:Zacas_amocasd_pma_instr]#`AMOCASD` indicates that
in addition to instructions indicated by `AMOCASW` level support, the `AMOCAS.D`
instruction is supported.# [#norm:Zacas_amocasq_pma_instr]#`AMOCASQ` indicates that in addition to instructions
